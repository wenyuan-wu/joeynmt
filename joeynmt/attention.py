...
class LastStateAttention(AttentionMechanism):
    """
    Implements attending only to the last encoder state.
    ...
    def __init__(self):
        ...
        super(LastStateAttention, self).__init__()
    ...
    def forward(self, query: torch.Tensor = None,
        ...
        alphas = torch.zeros_like(mask)

        # alphas: batch_size, 1, src_length
        alphas[:,:,src_length-1] = 1.0
